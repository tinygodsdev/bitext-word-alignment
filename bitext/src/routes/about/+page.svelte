...
>
	...
	<footer class="mt-14 border-t border-gray-200 pt-8 text-center text-sm text-gray-600 dark:border-gray-700 dark:text-gray-400">
		<p class="m-0">
			<a href={resolve('/')} class={linkClass}>Open {DISPLAY_NAME}</a>
		...
		<p class="mx-auto mt-5 max-w-md text-base leading-relaxed text-gray-700 dark:text-gray-300">
			...
			<a
				...
				class={linkClass}
				target="_blank"
				rel="noopener noreferrer">Dani Polani</a
			>. More

<script lang="ts">
	...
	const href = 'https://preply.com/en/?pref=MjI1NTg5OTI=&id=1778450837.497915&ep=w2';
</script>
...
>
	<p class="m-0">
		Personally, I use Preply for language learning. If you want to try an online tutor, our link
		includes
